...
const hasSoup = foods.forEach(function(food) {
    food.includes('soup');
});
// forEach does not return a value on it's own.  Declaring a variable and assigning its value from a forEach method will return 'undefined'
*/
...
/*
const hasSoup = foods.some(function(food) {
    food.includes('soup')
});
*/

const hasSoup = foods.some(food => {
    food.includes('soup')
});
...
/*
let sum = 0 
const total = numArrays.forEach(function(arr) {
